...
$(document).ready(function () {
    ...
    // 3. Sorting
    // ====================================================================================
    $(document).on("click", ".tkeluar_sorting", function () {
    ...
    // ====================================================================================
    let edit_id;
    $(document).on("click", "#btn-edit-tkeluar", function () {
        let id = $(this).data("id");
        edit_id = id;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                <td class="text-center">
                    <a href="javascript:void(0)" id="btn-edit-tkeluar" data-id="${data.data.id}" class="btn btn-icon icon-left btn-primary" ><i class="far fa-edit"></i> Edit</a>
                    <a href="javascript:void(0)" id="btn-del-tkeluar" data-id="${data.data.id}" class="btn btn-icon icon-left btn-danger" ><i class="fas fa-trash"></i> Hapus</a>
                </td>
                </tr>
                `;
                //append to post data
                $(`#${data.data.id}`).replaceWith(tkeluar);
    ...
    // 3. Delete Data
    // ====================================================================================
    $(document).on("click", "#btn-del-tkeluar", function () {
        let id = $(this).data("id");
