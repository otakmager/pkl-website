    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <button class="btn btn-icon icon-left btn-success py-2" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus"></i> Tambah Akun</button>
                                    ...
                                    <table class="table-striped table">
                                        <thead>
                                            <tr class="text-center">
                                                <th>No.</th>
                                                <th class="makun_sorting" data-sorting_type="asc" data-column_name="name" style="cursor: pointer">Nama</th>
                                                <th class="makun_sorting" data-sorting_type="asc" data-column_name="email" style="cursor: pointer">Email</th>
                                                <th class="makun_sorting" data-sorting_type="asc" data-column_name="status" style="cursor: pointer">Status</th>
                                                <th>Aksi</th>
                                            </tr>
                                        </thead>                                        
                                        <tbody id="table-data">@include('dashboard.fetch.makun-data')</tbody>      
                                    </table>
                                </div>
                                <form>
        ...
        @include('dashboard.modal.add-makun')
        @include('dashboard.modal.edit-makun')
    </div>
@endsection
