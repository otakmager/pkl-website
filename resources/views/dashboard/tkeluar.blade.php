    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <button class="btn btn-icon icon-left btn-success py-2" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus"></i> Tambah Transaksi Keluar</button>
                                    ...
                                    <table class="table-striped table">
                                        <thead>
                                            <tr class="text-center">
                                                <th>No.</th>
                                                <th class="tkeluar_sorting" data-sorting_type="asc" data-column_name="name" style="cursor: pointer">Nama</th>
                                                <th class="tkeluar_sorting" data-sorting_type="asc" data-column_name="label_id" style="cursor: pointer">Label</th>
                                                <th class="tkeluar_sorting" data-sorting_type="asc" data-column_name="nominal" style="cursor: pointer">Nominal</th>
                                                <th class="tkeluar_sorting" data-sorting_type="asc" data-column_name="tanggal" style="cursor: pointer">Tanggal</th>
                                                <th>Aksi</th>
                                            </tr>
                                        </thead>                                        
                                        <tbody id="table-data">@include('dashboard.fetch.tkeluar-data')</tbody>      
                                    </table>
                                </div>
                                <form>
        ...
        @include('dashboard.modal.add-tkeluar')
        @include('dashboard.modal.edit-tkeluar')
    </div>
@endsection
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/tkeluar.js') }}"></script>
@endpush
